...
export const V_BRANCH_FIELDS = picklist(["user", "version", "type", "ticket", "description"]);
...
export const BRANCH_ORDER_DEFAULTS: Output<typeof V_BRANCH_FIELDS>[] = ["user", "version", "type", "ticket", "description"]
